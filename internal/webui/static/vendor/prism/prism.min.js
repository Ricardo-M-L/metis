/* PrismJS 1.30.0 · MIT · https://github.com/PrismJS/prism/tree/v1.30.0
 * Vendored components: core, markup, css, clike, javascript, bash, go, typescript, json, yaml, markdown, python, rust, java, c, cpp, csharp, sql, ini, toml, docker, diff.
 * Upstream components are unmodified; manual mode keeps highlighting scoped to file previews.
 */
var Prism = { manual: true, disableWorkerMessageHandler: true };
