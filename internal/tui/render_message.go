...
func renderMessage(msg Message, width int, expand bool) string {
	...
	case "redacted_thinking":
		// Opaque provider replay data has no user-facing text. Keep it in
		// history, but render neither the payload nor a placeholder, even
		// when thinking is expanded. Public summaries use "thinking".
		return ""
